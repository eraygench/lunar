...
class ProductLimitationRelationManager extends BaseRelationManager
{
    ...
    public function getDefaultTable(Table $table): Table
    {
        return $table
            ...
            ->emptyStateHeading(
                __('lunarpanel::discount.relationmanagers.products.empty_state.label')
            )
            ->emptyStateDescription(
                __('lunarpanel::discount.relationmanagers.products.empty_state.description')
            )
            ->paginated(false)
            ->modifyQueryUsing(
            ...
            ->headerActions([
                Tables\Actions\CreateAction::make()
                    ->modalHeading(__('lunarpanel::discount.relationmanagers.products.actions.attach.label'))
                    ->form([
